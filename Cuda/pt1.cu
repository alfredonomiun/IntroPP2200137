//este codigo sirve para realizar la suma de dos arreglos en paralelo haciendo uso de GPU
...
#definir NB 32  // Número de bloques por rejilla
#definir NT 500 // Número de hilos por bloque
#definir N NB * NT // Tamaño total del arreglo
